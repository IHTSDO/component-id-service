...
class BulkSchemeIdControllerTest {
    ...
    void testGetSchemeIds_shouldReturnListOfIds() throws Exception {
        ...
        mockMvc.perform(get("/scheme/SNOMEDID/bulk")
    ...
    void testGetSchemeIds_shouldReturnEmptyList() throws Exception {
        ...
        when(bulkSchemeIdService.getSchemeIds(mockDto, schemeName, schemeIds))
                .thenReturn(List.of());
    ...
    void testGetSchemeIds_invalidEnum_shouldReturnError() throws Exception {
        ...
        mockMvc.perform(get("/scheme/INVALID/bulk")
                        .param("token", "dummy-token")
                        .param("schemeIds", "123")
                        .with(authentication(authToken)))
    ...
    void testGetSchemeIds_serviceThrowsCisException_shouldReturnErrorResponse() throws Exception {
        ...
        when(bulkSchemeIdService.getSchemeIds(mockDto, SchemeName.SNOMEDID, "123"))
    ...
    void testGenerateSchemeIds_validInput_shouldReturnJob() throws Exception {
        ...
        when(bulkSchemeIdService.generateSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenReturn(mockJob);
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/generate")
                        .param("token", "dummy-token")
    ...
    void testRegisterSchemeIds_validInput_shouldReturnJob() throws Exception {
        ...
        AuthenticateResponseDto mockDto = AuthenticateResponseDto.builder()
                ...
                .build();
        BulkJob mockJob = new BulkJob();
       when(bulkSchemeIdService.registerSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenReturn(mockJob);
        Authentication authToken = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token",
                "testuser",
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/register")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
    ...
    void testRegisterSchemeIds_withoutAuthentication_shouldReturnUnauthorized() throws Exception {
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/register")
                        ...
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(csrf()))  // CSRF is present, but no auth
                .andExpect(status().isUnauthorized());
    }
    @Test
    ...
    void testRegisterSchemeIds_invalidRequestBody_shouldReturnBadRequest() throws Exception {
        ...
        when(bulkSchemeIdService.registerSchemeIds(any(), any(), any()))
                .thenThrow(new CisException(HttpStatus.BAD_REQUEST, "Invalid data"));
    ...
    void testRegisterSchemeIds_serviceThrowsCisException_shouldReturnInternalServerError() throws Exception {
        ...
        AuthenticateResponseDto mockDto = AuthenticateResponseDto.builder()
                .name("admin").roles(List.of("ROLE_ADMIN")).build();

        when(bulkSchemeIdService.registerSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenThrow(new CisException(HttpStatus.INTERNAL_SERVER_ERROR, "Something went wrong"));

        Authentication authToken = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token", "admin", mockDto, AuthorityUtils.createAuthorityList("ROLE_ADMIN"));
    ...
    void testReserveSchemeIds_accessDenied_shouldReturnForbidden() throws Exception {
        ...
        when(bulkSchemeIdService.reserveSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenThrow(new AccessDeniedException("Access is denied"));
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/reserve")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
    ...
    void testReserveSchemeIds_success_shouldReturnOk() throws Exception {
        ...
        Authentication authToken = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token", "user", mockDto, AuthorityUtils.createAuthorityList("ROLE_USER")
        );
    ...
    void testReserveSchemeIds_invalidJson_shouldReturnBadRequest() throws Exception {
        ...
        Authentication authToken = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token", "user",
                AuthenticateResponseDto.builder().build(),
                AuthorityUtils.createAuthorityList("ROLE_USER")
        );
    ...
    void testReleaseSchemeIds_validRequest_shouldReturnOk() throws Exception {
        ...
        when(bulkSchemeIdService.releaseSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenReturn(mockJob);
        ...
        mockMvc.perform(put("/scheme/SNOMEDID/bulk/release")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
    ...
    void testReserveSchemeIds_cisException_shouldReturnInternalServerError() throws Exception {
        ...
        when(bulkSchemeIdService.reserveSchemeIds(any(), any(), any()))
                .thenThrow(new CisException(HttpStatus.INTERNAL_SERVER_ERROR,"Invalid scheme data"));
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/reserve")
                ...
                .andExpect(status().isInternalServerError())
                .andExpect(jsonPath("$.statusCode").value(500))
                .andExpect(jsonPath("$.message").value("Invalid scheme data"));
    }
    @Test
    ...
    void testReserveSchemeIds_missingCsrf_shouldReturnForbidden() throws Exception {
        ...
        mockMvc.perform(post("/scheme/SNOMEDID/bulk/reserve")
                        ...
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(new AuthorizationControllerMockMvcTest.TestToken(
                                "dummy-token", "user", AuthenticateResponseDto.builder().build(),
                                AuthorityUtils.createAuthorityList("ROLE_USER")
                        ))))
                .andExpect(status().isForbidden());
    ...
    void testDeprecateSchemeIds_success_shouldReturnBulkJob() throws Exception {
       ...
       AuthenticateResponseDto mockDto = AuthenticateResponseDto.builder()
        ...
        when(bulkSchemeIdService.deprecateSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenReturn(bulkJob);

        mockMvc.perform(put("/scheme/SNOMEDID/bulk/deprecate")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
    ...
    private static Stream<Arguments> deprecateSchemeIdScenarios() {
        ...
        Authentication validAuth = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token", "user", AuthenticateResponseDto.builder().build(),
                AuthorityUtils.createAuthorityList("ROLE_USER"));

        return Stream.of(
                Arguments.of("Missing token param", null, validAuth, csrf(), 400),
                Arguments.of("Missing auth", "dummy-token", null, csrf(), 401),
                Arguments.of("Missing CSRF", "dummy-token", validAuth, null, 403)
        );
    }

    @ParameterizedTest(name = "{0}")
    @MethodSource("deprecateSchemeIdScenarios")
    void testDeprecateSchemeIds_edgeCases(
            String name,
            String token,
            Authentication auth,
        ...
        var requestBuilder = put("/scheme/SNOMEDID/bulk/deprecate")
                .content(objectMapper.writeValueAsString(dto))
                .contentType(MediaType.APPLICATION_JSON);
    ...
    void testDeprecateSchemeIds_invalidSchemeName_shouldReturnBadRequest() throws Exception {
        ...
        mockMvc.perform(put("/scheme/INVALID_SCHEME/bulk/deprecate")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
    ...
    void testReleaseSchemeIds_serviceThrowsCisException_shouldReturnInternalServerError() throws Exception {
        ...
        when(bulkSchemeIdService.releaseSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenThrow(new CisException(HttpStatus.INTERNAL_SERVER_ERROR, "Service failure"));

        Authentication authToken = new AuthorizationControllerMockMvcTest.TestToken(
                "dummy-token", "user", mockDto,
                AuthorityUtils.createAuthorityList("ROLE_USER")
        );
    ...
    void testPublishSchemeIds_validRequest_shouldReturnOk() throws Exception {
        ...
        when(bulkSchemeIdService.publishSchemeIds(any(), eq(SchemeName.SNOMEDID), any()))
                .thenReturn(mockJob);
        ...
        mockMvc.perform(put("/scheme/SNOMEDID/bulk/publish")
                        .param("token", "dummy-token")
                        .content(objectMapper.writeValueAsString(dto))
                        .contentType(MediaType.APPLICATION_JSON)
                        .with(authentication(authToken))
