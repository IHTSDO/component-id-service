...
public class NamespaceService {
    ...
    public String createNamespaces(AuthenticateResponseDto authenticateResponseDto, NamespaceDto namespace) throws CisException, ParseException {
        ...
        if (this.isAbleToEdit(namespace.getNamespace(), authenticateResponseDto)) {
            ...
            logger.error("error createNamespaces():: user:{} has neither admin access nor namespace permission for the selected operation.namespace:{}",authenticateResponseDto.toString(),namespace.getNamespace());
    ...
    public String updateNamespace(AuthenticateResponseDto authenticateResponseDto, NamespaceDto namespace) throws CisException {
        logger.debug("NamespaceService.updateNamespace() authenticateResponseDto-{} :: namespace-{} ", authenticateResponseDto.toString(), namespace);
    ...
    public String updateNamespaces(AuthenticateResponseDto authenticateResponseDto, NamespaceDto namespace) throws CisException {
        logger.debug("NamespaceService.updateNamespaces() AuthenticateResponseDto-{} :: NamespaceDto-{} ", authenticateResponseDto.toString(), namespace);
        if (this.isAbleToEdit(namespace.getNamespace(), authenticateResponseDto)) {
            ...
            logger.error("error updateNamespaces():: user:{} has neither admin access nor namespace permission for the selected operation.namespace:{}",authenticateResponseDto.toString(),namespace.getNamespace());
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
    ...
    public String deleteNamespace(AuthenticateResponseDto authenticateResponseDto, String namespaceId) throws CisException {
        logger.debug("NamespaceService.deleteNamespace() AuthenticateResponseDto-{} :: namespaceId-{} ", authenticateResponseDto.toString(), namespaceId);
    ...
    public String deleteNamespaces(AuthenticateResponseDto authenticateResponseDto, String namespaceId) throws CisException {
        logger.debug("NamespaceService.deleteNamespaces() authenticateResponseDto-{} :: namespaceId-{} ", authenticateResponseDto.toString(), namespaceId);
        JSONObject response = new JSONObject();
        if (namespaceId.length() != 7 && namespaceId != "0")
            ...
            if (this.isAbleToEdit(Integer.valueOf(namespaceId), authenticateResponseDto)) {
                ...
                logger.error("error getSchemeIds():: user:{} has neither admin access nor namespace permission for the selected operation.namespace:{}",authenticateResponseDto.toString(),namespaceId);
                throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
    ...
    public String updatePartitionSequence(AuthenticateResponseDto authenticateResponseDto, String namespaceId, String partitionId, String value) throws CisException {
        logger.debug("NamespaceService.updatePartitionSequence() authenticateResponseDto-{} :: namespaceId-{} :: partitionId - {} :: value - {} ", authenticateResponseDto.toString(), namespaceId, partitionId, value);
    ...
    public String updatePartitionSequences(AuthenticateResponseDto authenticateResponseDto, String namespaceId, String partitionId, String value) throws CisException {
        logger.debug("NamespaceService.updatePartitionSequences() authenticateResponseDto-{} :: namespaceId -{} :: partitionId - {} :: value-{} ", authenticateResponseDto.toString(), namespaceId, partitionId, value);
        String out = "";
    ...
    public String deleteNamespacePermissionsOfUser(String namespaceId, String username, AuthenticateResponseDto authenticateResponseDto) throws CisException {
        logger.debug("NamespaceService.deleteNamespacePermissionsOfUser() namespaceId-{} :: AuthenticateResponseDto-{} ", namespaceId, authenticateResponseDto.toString());
        if (isAbleToEdit(Integer.valueOf(namespaceId), authenticateResponseDto)) {
            ...
            logger.error("error deleteNamespacePermissionsOfUser():: user:{} has neither admin access nor namespace permission for the selected operation. namespace:{}",authenticateResponseDto.toString(),namespaceId);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
        }
    }
    ...
    public String createNamespacePermissionsOfUser(String namespaceId, String username, String role, AuthenticateResponseDto authenticateResponseDto) throws CisException {
        logger.debug("NamespaceService.createNamespacePermissionsOfUser() namespaceId-{} :: username - {} :: role - {} :: AuthenticateResponseDto-{} ", namespaceId, username, role, authenticateResponseDto.toString());
        if (isAbleToEdit(Integer.valueOf(namespaceId), authenticateResponseDto)) {
            ...
            logger.error("error createNamespacePermissionsOfUser():: user: {} has neither admin access nor namespace permission for the selected operation. namespace:{}",authenticateResponseDto.toString(),namespaceId);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
        }
    }
