...
public class BulkSchemeIdService {
    ...
    public List<SchemeId> getSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, String schemeIds) throws CisException {
        logger.debug("BulkSchemeIdService.getSchemeIds() token-{} :: schemeName-{} :: schemeIds -{}", token.toString(), schemeName, schemeIds);
    ...
    public BulkJob generateSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkGenerationRequestDto schemeIdBulkDto) throws CisException {
        logger.debug("BulkSchemeIdService.generateSchemeIds() token - {} :: schemeName - {} :: schemeIdBulkDto - {}", token.toString(), schemeName, schemeIdBulkDto);
        ...
        boolean able = schemeIdService.isAbleUser(String.valueOf(schemeName), token);
        if (!able) {
            logger.error("error generateSchemeIds():: user: {} has neither admin access nor scheme permission for the selected operation. schemeName:{}",token.toString(), schemeName);
...
// Type is set here not as an attribute
    ...
    public BulkJob registerSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkRegisterRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.registerSchemeIds() token - {} :: schemeName - {} :: request - {}", token.toString(), schemeName, request);
    ...
    public BulkJob registerBulkSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkRegisterRequestDto schemeIdBulkRegisterDto) throws CisException {
        logger.debug("BulkSchemeIdService.registerBulkSchemeIds() token - {} ::schemeName- {} :: schemeIdBulkRegisterDto - {}", token.toString(), schemeName, schemeIdBulkRegisterDto);
        ...
        if (schemeIdService.isAbleUser(String.valueOf(schemeName), token)) {
            ...
            logger.error("error registerBulkSchemeIds():: user :{} has neither admin access nor scheme permission for the selected operation.scheme:{}",token.toString(),schemeName);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
    ...
    public BulkJob reserveSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkReserveRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.reserveSchemeIds() token - {} :: schemeName - {} :: request - {}", token.toString(), schemeName, request);
    ...
    public BulkJob reserveBulkSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkReserveRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.reserveBulkSchemeIds() token - {} ::schemeName -  {} :: request - {}", token.toString(), schemeName, request);
        BulkJob bulkJob = new BulkJob();
        if (schemeIdService.isAbleUser(String.valueOf(schemeName), token)) {
            ...
            logger.error("error reserveBulkSchemeIds():: user: {} has neither admin access nor scheme permission for the selected operation.scheme:{}",token.toString(),schemeName);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
    ...
    public BulkJob deprecateSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.deprecateSchemeIds() token - {} ::schemeName- {} :: request - {}", token.toString(), schemeName, request);
    ...
    public BulkJob deprecateBulkSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.deprecateBulkSchemeIds() token - {} :: schemeName - {} :: request - {} ", token.toString(), schemeName, request);
        BulkJob bulkJob = new BulkJob();
        if (schemeIdService.isAbleUser(String.valueOf(schemeName), token)) {
            ...
            logger.error("error deprecateBulkSchemeIds():: user:{} has neither admin access nor scheme permission for the selected operation.scheme:{}",token.toString(),schemeName);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
...
//releaseSchemeIds
    ...
    public BulkJob releaseSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.releaseSchemeIds() token - {} ::schemeName- {} :: request -{}", token.toString(), schemeName, request);
    ...
    public BulkJob releaseBulkSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.releaseBulkSchemeIds() token - {} ::schemeName- {} :: request - {}", token.toString(), schemeName, request);
        BulkJob bulkJob = new BulkJob();
        ...
        if (schemeIdService.isAbleUser(String.valueOf(schemeName), token)) {
            ...
            logger.error("error releaseBulkSchemeIds():: user:{} has neither admin access nor scheme permission for the selected operation.scheme:{}", token.toString(),schemeName);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
    ...
    public BulkJob publishSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.publishSchemeIds() token-{} ::schemeName- {} :: request -{}", token.toString(), schemeName, request);
    ...
    public BulkJob publishBulkSchemeIds(AuthenticateResponseDto token, SchemeName schemeName, SchemeIdBulkDeprecateRequestDto request) throws CisException {
        logger.debug("BulkSchemeIdService.publishBulkSchemeIds() token-{} ::schemeName- {} :: request -{}", token.toString(), schemeName, request);
        BulkJob bulkJob = new BulkJob();
        if (schemeIdService.isAbleUser(String.valueOf(schemeName), token)) {
            ...
            logger.error("error publishBulkSchemeIds():: user : {} has neither admin access nor scheme permission for the selected operation.scheme:{}", token.toString(),schemeName);
            throw new CisException(HttpStatus.UNAUTHORIZED, "No permission for the selected operation");
